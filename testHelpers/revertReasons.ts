export default {
  ...
  BAD_RECEIVER_IMPLEMENTATION:
    'ERC721: transfer to a bad receiver implementation',
  ...
  VALID_FROM_MUST_BE_AT_LEAST_5_MINUTES_LESS_THAN_VALID_TO:
    'VALID_FROM_MUST_BE_AT_LEAST_5_MINUTES_LESS_THAN_VALID_TO',
  CONDITION_NOT_AVAILABLE_FOR_TOKEN_TYPE: 'CONDITION_NOT_AVAILABLE_FOR_TOKEN_TYPE'
};

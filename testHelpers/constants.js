...
//promise
const PROMISE_VALID_FROM 	= Math.floor(Date.now() / 1000);//1573730299;
const PROMISE_VALID_TO 		= PROMISE_VALID_FROM + 2*SECONDS_IN_DAY;
...
const PROMISE_CHALLENGE_PERIOD = 2;
const PROMISE_CANCELORFAULT_PERIOD = 2;

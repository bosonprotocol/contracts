...
namespace :contracts do
  ...
  task :compile => [:'dependencies:install'] do
    sh({"PROTOCOL_DEPLOYER_PRIVATE_KEY" => "123456789abcdef123456789abcdef123456789abcdef123456789abcdef1234"}, 'npm', 'run', 'contracts:compile')
  end
...
namespace :tests do
  ...
  task :unit, [:port, :account_keys_file] =>
    ...
    run_unit_tests = lambda do ||
      sh({"PROTOCOL_DEPLOYER_PRIVATE_KEY" => "123456789abcdef123456789abcdef123456789abcdef123456789abcdef1234"}, 'npm', 'run', 'tests:unit')

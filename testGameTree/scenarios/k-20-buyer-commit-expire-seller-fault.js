...
describe('TEST SCENARIO 019 :: SELLER CREATES & BUYER COMMITS', async function () {
  ...
  it('TEST SCENARIO 19 :: SELLER CREATE :: 2.1 VALIDATE ISSUER', async function () {
    aql(commitVoucherDetails['issuer'], users.seller.address);
  });

  it('TEST SCENARIO 19 :: SELLER CREATE :: 2.2 VALIDATE HOLDER', async function () {
  ...
  it('TEST SCENARIO 20 :: SELLER FAULTS :: 5.0 Seller admits fault on a expired voucher', async function () {
  ...
  it('TEST SCENARIO 20 :: SELLER FAULTS :: 5.1 VALIDATE FAULTED VOUCHER', async function () {
    aql(
